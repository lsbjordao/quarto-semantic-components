...
[`v0.11.0`]{.badge type="accent" font="mono"}
```

**Output:** [**Stable**]{.badge type="success" appearance="outline" size="md"} [`v0.11.0`]{.badge type="accent" font="mono"}
...
```markdown
:::: {.article accent="left" accent-color="success"}
## Release package [v0.11.0]{.badge type="success" appearance="solid" size="xs"}
...
| Format | Behavior |
|---|---|
| **HTML** | Full styling, light/dark color overrides, badges, SVG Git DAG, expandable file tree, info hints, and native article collapse/expand |
